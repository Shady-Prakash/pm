    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <p className="text-green-400 font-mono text-sm mb-2">admin access</p>
          <h1 className="text-3xl font-bold text-zinc-100">PM. Admin</h1>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 space-y-6">
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white text-zinc-900 font-semibold rounded-lg hover:bg-zinc-100 transition-colors text-sm"
            >
