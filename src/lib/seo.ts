...
export const SITE_DESCRIPTION =
  'Sydney-based Software Engineer with 4+ years of experience building fast, scalable web applications with React, Next.js and TypeScript. Currently deep-diving into AI and automation with Python.'
